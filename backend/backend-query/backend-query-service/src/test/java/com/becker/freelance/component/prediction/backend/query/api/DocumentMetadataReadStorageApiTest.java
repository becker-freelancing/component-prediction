...
class DocumentMetadataReadStorageApiTest {
    ...
    private ApiDocumentMetadataReadRepositoryImpl storageApi;

    @BeforeEach
    void setUp() {
        metadataRepository = Mockito.mock(DocumentMetadataRepository.class);
        storageApi = new ApiDocumentMetadataReadRepositoryImpl(metadataRepository, new GrpcMapper());
    }
    ...
    void findAllWithEmptyResult() {
        ...
        GrpcQueryDocumentMetadataList expected = GrpcQueryDocumentMetadataList.newBuilder().build();
    ...
    void findAll() {
        ...
        GrpcQueryDocumentMetadataList expected = GrpcQueryDocumentMetadataList.newBuilder()
