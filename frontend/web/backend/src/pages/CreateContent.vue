<template>
    <div class="default-margin">
        ...
        <div class="form-row">
            ...
            <textarea id="action-description" type="text"  v-model="description" :class="{invalid: !descriptionValid}"></textarea>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <textarea id="action-short-description" type="text" :disabled="equalDescription" v-model="shortDescription" :class="{invalid: !shortDescriptionValid}"></textarea>
        </div>
        <div class="form-row">
