...
public class DocumentMetadata {
    ...
    public DocumentMetadata(UUID id, App app, String inAppActionPath, String actionTitle, String actionDescription, String actionShortDescription, Locale locale, BigInteger version, ZonedDateTime createdAt, Set<Tag> tags) {
        this.id = id;
        this.app = app;
    ...
    public DocumentMetadata(App app, String inAppActionPath, String actionTitle, String actionDescription, String actionShortDescription, Locale locale, BigInteger version, ZonedDateTime createdAt, Set<Tag> tags) {
        this(
                null,
                app,
                inAppActionPath,
